...
Assignment where i worked on machine learning with the goal of visualizing a preferred number of clusters.
	
	Assignment Overview
-loading data into python
-cleaning data through normalization
-cleaning data through dropping columns
-method of finding k value
